...
run() {
  ...
  group("into", () {
    ...
    test("- PersistentMap", () {
      PMap s = persist({'a': 5});
      expect(into(s, [new Pair('b', 6), new Pair('a', 8)]),
          equals(s.assoc('b', 6).assoc('a', 8)));
    });
  ...
  group("zipmap", () {
    test("", () {
      expect(
          zipmap(['a', 'b', 'c'], [1, 2, 3]), eqPer({'a': 1, 'b': 2, 'c': 3}));
      expect(zipmap(['a', 'b', 'c'], [1, 2, 3, 4, 5]),
          eqPer({'a': 1, 'b': 2, 'c': 3}));
      expect(zipmap(['a', 'b', 'c', 'd', 'e'], [1, 2, 3]),
          eqPer({'a': 1, 'b': 2, 'c': 3}));
    });
  });
